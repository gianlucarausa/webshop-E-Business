...
Sie finden unsere Projektplanung und Aufgabenverteilung in dem Dokument "Projektplan & Konzept.xlsx"

### Anmerkung

Bezüglich des dritten Punkts aus der Abgabe, wir haben in unserem Projekt in dem Ordner "db" das SQL-Skript "initdb.sql" abglegt. Dieses wird durch das docker-compose automatisch ausgeführt und erstellt die initiale Datenbank. Dies ist gleichzeitig der komplette Auszug unserer Datenbank.Wir hoffen das dies der von Ihnen gewünschten Abgabe entspricht. 
...
Im Ordner db sind das SQL-Skript "initdb.sql" und das ER-Diagramm der Database webshop hinterlegt.
